 ...
 */
 sendRegisterSMS = function (mobile,code,type,name, nickname) {
     ...
     if(type)
         sendMessageSync("template:register",mobile,{ code:code, minutes:Accounts._options.verificationValidDuration/1000/60});
     else
         sendMessageSync("template:mobile_confirm",mobile,{ code:code, minutes:Accounts._options.verificationValidDuration/1000/60, name:name, nickname:nickname});
 };
